...
ElasticMongoose.prototype.connect = function(options, callback) {
...
ElasticMongoose.prototype.refresh = function(arg1, arg2) {
	...
	options.index = options.index ? options.index : this.options.index;
